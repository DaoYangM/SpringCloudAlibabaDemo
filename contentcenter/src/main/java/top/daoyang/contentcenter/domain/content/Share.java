...
public class Share {
    ...
    /**
     * 审核状态 NOT_YET: 待审 PASSED:审核通过 REJECTED:审核不通过
     */
    ...
    /**
     * 获取审核状态 NOT_YET: 待审 PASSED:审核通过 REJECTED:审核不通过
     *
     * @return audit_status - 审核状态 NOT_YET: 待审 PASSED:审核通过 REJECTED:审核不通过
     */
    ...
    /**
     * 设置审核状态 NOT_YET: 待审 PASSED:审核通过 REJECTED:审核不通过
     *
     * @param auditStatus 审核状态 NOT_YET: 待审 PASSED:审核通过 REJECTED:审核不通过
     */
